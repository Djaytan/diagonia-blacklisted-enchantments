...
import fr.djaytan.minecraft.blacklisted_enchants.controller.api.parameter.MessageType;
...
public class MessageControllerImpl implements MessageController {
  ...
  private @NotNull Component formatMessage(
    ...
    String messageFormatKey =
        switch (messageType) {
          case INFO -> "blacklisted_enchants.common.message.format.info";
          case SUCCESS -> "blacklisted_enchants.common.message.format.success";
          case FAILURE -> "blacklisted_enchants.common.message.format.failure";
          case WARNING -> "blacklisted_enchants.common.message.format.warning";
          case ERROR -> "blacklisted_enchants.common.message.format.error";
          case BROADCAST -> "blacklisted_enchants.common.message.format.broadcast";
          case DEBUG -> "blacklisted_enchants.common.message.format.debug";
        };
