...
import fr.djaytan.minecraft.blacklisted_enchants.model.config.serializers.PluginConfigSerializersFactory;
import javax.inject.Inject;
import org.bukkit.plugin.java.JavaPlugin;

public class BlacklistedEnchantsPlugin extends JavaPlugin {
    ...
    try {
      ...
      ConfigController configController =
          new ConfigControllerImpl(
              new PluginConfigSerializersFactory().factory(), this);
      ...
      Injector injector =
          Guice.createInjector(
              ...
              new GuicePluginModule(getSLF4JLogger(), pluginConfig));
