  ...
  public @NotNull Component removedBlacklistedEnchants(
    ...
    if (removedBlacklistedEnchants.size() == 1) {
      ...
      return miniMessage.deserialize(
          resourceBundle.getString("blacklisted_enchants.enchants.message.removed_enchant"),
    ...
    return miniMessage.deserialize(
        resourceBundle.getString("blacklisted_enchants.enchants.message.removed_enchants"),
        TagResolver.resolver(
            Placeholder.component(
                "be_enchants",
                Component.join(
                    JoinConfiguration.separators(
                        miniMessage.deserialize(
                            resourceBundle.getString("blacklisted_enchants.common.separator.list")),
                        miniMessage.deserialize(
                            resourceBundle.getString("blacklisted_enchants.common.separator.list.last"))),
