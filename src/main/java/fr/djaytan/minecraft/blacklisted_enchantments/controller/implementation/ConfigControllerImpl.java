...
package fr.djaytan.minecraft.blacklisted_enchantments.controller.implementation;

import com.google.common.base.Preconditions;
import fr.djaytan.minecraft.blacklisted_enchantments.BlacklistedEnchantmentsRuntimeException;
import fr.djaytan.minecraft.blacklisted_enchantments.controller.api.ConfigController;
import fr.djaytan.minecraft.blacklisted_enchantments.model.config.ConfigFile;
import fr.djaytan.minecraft.blacklisted_enchantments.model.config.data.PluginConfig;
import fr.djaytan.minecraft.blacklisted_enchantments.model.config.serializers.BlacklistedEnchantmentsConfigSerializers;
...
public class ConfigControllerImpl implements ConfigController {
  ...
  private final BlacklistedEnchantmentsConfigSerializers blacklistedEnchantmentsConfigSerializers;
  private final Plugin plugin;

  @Inject
  public ConfigControllerImpl(
      @NotNull BlacklistedEnchantmentsConfigSerializers blacklistedEnchantmentsConfigSerializers,
      @NotNull Plugin plugin) {
    this.dataFolder = plugin.getDataFolder().toPath();
    this.blacklistedEnchantmentsConfigSerializers = blacklistedEnchantmentsConfigSerializers;
    this.plugin = plugin;
  }
  ...
  public <T> @NotNull T loadConfig(@NotNull ConfigFile configFile, @NotNull Class<T> clazz) {
            ...
            .defaultOptions(
                configurationOptions ->
                    configurationOptions.serializers(
                        builder ->
                            builder.registerAll(
                                blacklistedEnchantmentsConfigSerializers.collection())))
    ...
    try {
      ...
      if (config == null) {
        throw new BlacklistedEnchantmentsRuntimeException(
            String.format(
