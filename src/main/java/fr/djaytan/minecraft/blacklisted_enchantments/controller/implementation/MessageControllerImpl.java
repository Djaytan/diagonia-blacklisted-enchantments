...
import fr.djaytan.minecraft.blacklisted_enchantments.controller.api.parameter.MessageType;
...
public class MessageControllerImpl implements MessageController {
  ...
  private @NotNull Component formatMessage(
    ...
    String messageFormatKey =
        switch (messageType) {
          case INFO -> "blacklisted_enchantments.common.message.format.info";
          case SUCCESS -> "blacklisted_enchantments.common.message.format.success";
          case FAILURE -> "blacklisted_enchantments.common.message.format.failure";
          case WARNING -> "blacklisted_enchantments.common.message.format.warning";
          case ERROR -> "blacklisted_enchantments.common.message.format.error";
          case BROADCAST -> "blacklisted_enchantments.common.message.format.broadcast";
          case DEBUG -> "blacklisted_enchantments.common.message.format.debug";
        };

    return miniMessage
        .deserialize(
            resourceBundle.getString(messageFormatKey),
            TagResolver.resolver(Placeholder.component("be_message_content", message)))
