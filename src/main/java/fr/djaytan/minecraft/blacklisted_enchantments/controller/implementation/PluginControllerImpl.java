...
import fr.djaytan.minecraft.blacklisted_enchantments.plugin.ListenerRegister;
import fr.djaytan.minecraft.blacklisted_enchantments.view.message.CommonMessage;
