  ...
  public @NotNull Component removedBlacklistedEnchants(
    ...
    if (removedBlacklistedEnchants.size() == 1) {
      ...
      return miniMessage.deserialize(
          resourceBundle.getString("blacklisted_enchantments.enchants.message.removed_enchant"),
          TagResolver.resolver(
              Placeholder.component(
                  "be_enchant", Component.translatable(removedBlacklistedEnchantment))));
    }

    return miniMessage.deserialize(
        resourceBundle.getString("blacklisted_enchantments.enchants.message.removed_enchants"),
        TagResolver.resolver(
            Placeholder.component(
                "be_enchants",
                Component.join(
                    JoinConfiguration.separators(
                        miniMessage.deserialize(
                            resourceBundle.getString("blacklisted_enchantments.common.separator.list")),
                        miniMessage.deserialize(
                            resourceBundle.getString("blacklisted_enchantments.common.separator.list.last"))),
