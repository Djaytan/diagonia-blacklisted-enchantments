...
import fr.djaytan.diagonia.BlacklistedEnchantmentsRuntimeException;
import fr.djaytan.diagonia.controller.api.ConfigController;
import fr.djaytan.diagonia.model.config.ConfigFile;
import fr.djaytan.diagonia.model.config.data.PluginConfig;
import fr.djaytan.diagonia.model.config.serializers.BlacklistedEnchantmentsConfigSerializers;
...
public class ConfigControllerImpl implements ConfigController {
  ...
  private final BlacklistedEnchantmentsConfigSerializers diagoniaConfigSerializers;
  private final Plugin plugin;

  @Inject
  public ConfigControllerImpl(
      @NotNull BlacklistedEnchantmentsConfigSerializers diagoniaConfigSerializers,
